...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'state_index_red = cal_rtheta.state_index_red:main',
            'state_index_blue = cal_rtheta.state_index_blue:main',
            'cmd_state = cal_rtheta.cmd_state:main',
            'xy_to_rtheta_index_red = cal_rtheta.xy_to_rtheta_index_red:main',
            'xy_to_rtheta_index_blue = cal_rtheta.xy_to_rtheta_index_blue:main',
